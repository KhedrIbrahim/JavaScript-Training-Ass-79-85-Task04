...
let objectLength = Object.keys(myFavGames).length ;// Object.keys : return the property inside object as array


for (let i = 0; i < objectLength; i++) {
    console.log(`The Game Name Is ${Object.keys(myFavGames)[i]}`); // here we chose first property inside object
